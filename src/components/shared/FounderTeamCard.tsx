      ...
      <motion.article className="founder-team-card relative h-full" {...motionProps}>
        ...
        <div className="founder-team-card__frame relative h-full rounded-[2rem] p-[1.5px]">
          <div className="founder-team-card__body relative flex h-full flex-col overflow-hidden rounded-[calc(2rem-1.5px)] border border-white/[0.08] bg-[#070b12]/92 p-6 sm:p-7">
            ...
            <div className="founder-team-card__scanline pointer-events-none absolute inset-0" aria-hidden="true" />

            <div className="relative z-[1] flex items-start justify-between gap-3">
              <span className="founder-team-card__badge inline-flex items-center gap-1.5 rounded-full border border-amber-300/40 bg-amber-300/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-amber-100">
            ...
            <div className="relative z-[1] mt-6 flex flex-col items-center text-center">
              <div className="founder-team-card__avatar-wrap relative">
                ...
                <div className="founder-team-card__avatar relative h-28 w-28 overflow-hidden rounded-[1.75rem] border border-sky-400/40 bg-sky-400/10 p-1 shadow-[0_0_40px_rgba(0,188,254,0.25)]">
              ...
              <p className="founder-team-card__role mt-1 text-sm font-bold">{member.role}</p>
            </div>
            ...
            <div className="relative z-[3] mt-6 flex flex-wrap items-center justify-center gap-2 border-t border-white/10 pt-5">
              ...
              <span className="founder-team-card__chip inline-flex items-center rounded-full border border-sky-400/25 bg-sky-400/10 px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.16em] text-sky-200">
                Creative leadership
              </span>
            </div>
          </div>
