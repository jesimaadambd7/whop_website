export const creatorBenefits = [
  ...
  {
    step: "02",
    title: "A page built for creative work",
    description:
      "Use cinematic, editorial, or minimal themes designed around video, imagery, case studies, and project context.",
  },
  {
    step: "03",
  ...
  {
    step: "04",
    title: "Know what clients watch",
    description:
      "Track profile views, video plays, contact clicks, directory discovery, and portfolio inquiries.",
  },
  {
    step: "05",
...
export const creatorSteps = [
  {
    step: "01",
    title: "Create",
    description: "Reserve your username and verify your email.",
  },
  {
    step: "02",
    title: "Activate",
    description: "Complete the secure one-time payment.",
  },
  {
    step: "03",
    title: "Build",
    description: "Choose a theme, add profile details, projects and media.",
  },
  {
    step: "04",
    title: "Review",
    description: "Submit for quality and rights review before public launch.",
  },
] as const;

export const creatorComparisonRows = [
  {
    label: "Setup",
...
export const creatorTerms = [
  {
    ...
    description:
      "Public portfolios and new hosted media require review. Creators must own or have permission to show every uploaded asset.",
  },
  {
    title: "Refunds",
    description:
      "Seven-day refund requests are eligible only before publication and before any premium resource download.",
  },
  {
