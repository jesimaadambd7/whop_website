    ...
    videos: [
      {
        ...
        hook: "Backend-uploaded UGCViss portfolio video.",
        result: "Uploaded from the UGCViss portfolio control panel.",
        description: "A UGCViss backend-managed portfolio video.",
