...
const title = `${member.name} - ${member.role} of UGCViss`;
const description = `Read ${member.name}'s founder journey from video editing and production to building UGCViss as a shoot-to-sales creative agency.`;
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${member.name} - Founder journey at UGCViss`,
      },
    ],
    type: "profile",
  },
